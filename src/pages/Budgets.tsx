      ...
      <Card className="mb-5">
        <div className="flex items-start justify-between mb-3">
          ...
          <div className="text-right">
            <p className="text-xs text-[#877275]">�ã chi</p>
          ...
          <>
            ...
            <div className="flex justify-between text-xs">
              <span className={`font-medium ${totalUsage.status === 'over' ? 'text-[#9b3f5a]' : totalUsage.status === 'warning' ? 'text-amber-500' : 'text-[#877275]'}`}>
                ...
                {totalUsage.status === 'over' && ' ⚠� Vượt ngân sách!'}
                {totalUsage.status === 'warning' && ' ⚠� Sắp hết'}
              </span>
